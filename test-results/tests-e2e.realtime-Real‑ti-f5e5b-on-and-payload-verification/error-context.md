...
- Name: tests/e2e.realtime.spec.ts >> Real‑time verification suite >> Room creation and payload verification
- Location: tests/e2e.realtime.spec.ts:49:3
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`bom1::k2fzz-1781513130752-ba1821340db2`"
