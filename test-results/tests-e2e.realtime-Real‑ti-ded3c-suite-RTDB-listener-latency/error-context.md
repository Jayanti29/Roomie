...
- Name: tests/e2e.realtime.spec.ts >> Real‑time verification suite >> RTDB listener latency
- Location: tests/e2e.realtime.spec.ts:68:3
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`bom1::dtkxk-1781513161728-b93a35caddaa`"
